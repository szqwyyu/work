...
using System.Linq;                    // для Take(), ToList()
using System.Threading.Tasks;        // для Task<>
using Microsoft.Extensions.Logging; // для ILogger<T>
...
namespace PetShop.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Contact(ContactMessage contactMessage) // ПЕРЕИМЕНОВАНО
        {
