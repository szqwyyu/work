...
using System.Linq;                      // для Any, FirstOrDefault
using System.Threading.Tasks;           // для Task<T>
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(User user)
        {
            ...
            if (existingUser != null)
            {
                ...
                // ИСПРАВЛЕНО: Url.Action возвращает строку, не нужно передавать ничего лишнего
